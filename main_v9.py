...
def run(
    ...
    with open('samples/camera2.yml', 'r') as file: 
    ...
    if os.path.isfile(local_file_name) == False:
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if min % 10 == 0 and cur_min != pre_min:	# For 10 mins, filter out same min
                ...
                url_link = 'https://bp.zdaly.com:5010/api/Survey/SaveVideoAnalytics?CustomerID=' + str(CustomerID) + '&StationID=' + str(StationID) +   '&NameOfMetric=CarsNumber&Value=' + str(current_count) + '&Created=' + str(timestamp) + '&Camera_Category=' + Camera_Category
